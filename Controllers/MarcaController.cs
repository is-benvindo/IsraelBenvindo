...
namespace israel_benvindo.Controllers
{
    public class MarcaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Nome,Descricao")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Nome,Descricao")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
